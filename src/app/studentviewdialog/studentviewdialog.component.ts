...
@Component({
  ...
  standalone: true,
  imports: [
    MatDialogTitle, MatDialogContent,RouterLink, RouterLinkActive,CommonModule,MatIconModule
...
export class StudentviewdialogComponent  {
   ...
   *
   */
  constructor(private route: ActivatedRoute, private router : Router,private dialogRef: MatDialogRef<StudentviewdialogComponent>) {
    debugger;
